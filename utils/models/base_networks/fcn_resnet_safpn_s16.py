...
from utils.models.base_networks.attention.safpn import SAFPN


class FCNMyFPNS16(nn.Module):
    def __init__(self, n_classes):
        ...
        # resnet50_32s.load_state_dict(torch.load(r'resnet50-IMAGENET1K_V1.pth'))
        ...
        self.fpn = SAFPN([256, 512, 1024, 2048], 256, s=16)
    ...
    def forward(self, x):
        ...
        res_16s = self.score_16s_p4(p4) + res_32s
...
if __name__ == '__main__':
    net = FCNMyFPNS16(1).cuda()
    summary(net, (1, 3, 864, 1152))
