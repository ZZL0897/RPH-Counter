...
class FCNPaFPNS16(nn.Module):
    def __init__(self, n_classes):
        ...
        self.fpn = PAFPN([256, 512, 1024, 2048], 256, s=16)
    ...
    def forward(self, x):
        ...
        res_16s = self.score_16s_p4(p4) + self.score_16s_n4(n4) + res_32s
